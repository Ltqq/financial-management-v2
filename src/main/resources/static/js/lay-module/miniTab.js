...
// console.log(element);
    var miniTab = {
        ...
        create: function (options) {
             ...
             * todo 修改 --start---
             */
            var str = ''+ options.href+'';
            let str_new = str.replace(/\//g,'_');

            // console.log(str_new,'sss');
            //----end ----
            ele.tabAdd('layuiminiTab', {
                ...
                , content: '<iframe width="100%" id="' + str_new+ '" height="100%" frameborder="no" border="0" marginwidth="0" marginheight="0"   src="' + options.href + '"></iframe>'
                , id: options.tabId
            });
        ...
        listen: function (options) {
            ...
            $('body').on('click', '[layuimini-href]', function () {
                ...
                layer.close(loading);
                // window.location.reload();
                console.log('334443333');
                console.log(tabId);
                var str = ''+ tabId+'';
                let str_new = str.replace(/\//g,'_');
                if(str_new == "_admin_server_index"){
                    $("#_admin_server_index").attr('src', $('#_admin_server_index').attr('src'));
                    //location.reload(true);
                }else if(str_new == "_admin_server_add"){
                    $("#_admin_server_add").attr('src', $('#_admin_server_add').attr('src'));
                }
                // window.parent.parent.document.getElementsByClassName("ifrmname").contentWindow.location.reload(true);
